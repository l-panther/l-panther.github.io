...
const web = new Skillset(
	...
	"As a Web Develper, I develop the web system using the latest web and server technologies such as HTML5, CSS3 JavaScript, PHP, Bootstrap and w3.CSS. My current portfolio consists of websites and web applications built using object-orietation, templates and custom design techniques.</p><p class='pt-3'>For front-end development, I uilise my skills as a <span id='art-modal-details' data-toggle='modal' data-target='#detailModal'>2D/3D Artist</span>, to manipulate and create digital images using <span id='technician-modal' data-toggle='modal' data-target='#detailModal'>computer software</span> Krita and Maya. Implementation of back-end development is achieved by hard coding data into vairables, retrieving of data from json files and querying databases.</p>",
	[
		{
			"id": 1,
			"title": "Plan",
