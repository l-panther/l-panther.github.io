						<div role="navigation" class="w3-sidenav w3-collaspe w3-hide-large w3-hide-large w3-animate-left">
							<ul>
								...
								<li><a href="#view-staff" onclick="w3.show('#view-staffList'), w3.hide('#admin-stat'), w3.hide('#add-staffList'), w3.hide('.w3-sidenav')">Staff<i class="fa fa-chevron-right"></i></a></li>
