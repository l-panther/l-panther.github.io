$(document).ready(function() {
	...
	for (var i = 0; i < projects.length; i++) {
		...
		*/
		...
		output += "<div class='w3-padding' title='View website in new tab'><i class='fa fa-globe'></i><a href='https://l-panther.github.io/data/projects/" + projects[i].url + ".index.php' target='_blank'><span class='w3-hide-small'>VIEW</span> WEBSITE</a></div>";
		output += "</div> <!-- End column -->";		
